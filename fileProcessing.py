...
def alphaComposite(og, inv):
    ...
    while (vid1.isOpened()):
        ...
        compositedFrame = cv.addWeighted(frame1,0.5,frame2,0.5,0.0)
        cv.imshow("frame", compositedFrame)
...
#print("Created Composited Video at: " + composite(original,inverted,1,"DIFFERENCE"))
